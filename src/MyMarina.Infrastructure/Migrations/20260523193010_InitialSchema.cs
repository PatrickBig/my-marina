        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSetupComplete = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    SetupStep = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    OnboardingConfig = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransientRateKind = table.Column<string>(type: "text", nullable: true),
                    TransientAmount = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    TransientMinCharge = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    LeaseRateKind = table.Column<string>(type: "text", nullable: true),
                    LeaseAmount = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    LeaseMinCharge = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    add_ons = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_pricing_plans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_pricing_plans_marinas_MarinaId",
                        column: x => x.MarinaId,
                        principalSchema: "mymarina",
                        principalTable: "marinas",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasPumpOut = table.Column<bool>(type: "boolean", nullable: false),
                    IsCovered = table.Column<bool>(type: "boolean", nullable: false),
                    IsIndoor = table.Column<bool>(type: "boolean", nullable: false),
                    Amenities = table.Column<string>(type: "jsonb", nullable: false, defaultValueSql: "'[]'::jsonb"),
                    Status = table.Column<string>(type: "text", nullable: false),
                    Latitude = table.Column<decimal>(type: "numeric(9,6)", precision: 9, scale: 6, nullable: true),
                    Longitude = table.Column<decimal>(type: "numeric(9,6)", precision: 9, scale: 6, nullable: true),
                    AddressStreet = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    ResolvedTransientBaseRate = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    ResolvedLeaseBaseRate = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    Notes = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_slips_pricing_plans_PricingPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaseTerm = table.Column<string>(type: "text", nullable: true),
                    ...
                    MinCharge = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_pricing_plans_marina_single_default",
                schema: "mymarina",
                table: "pricing_plans",
                column: "MarinaId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_pricing_plans_MarinaId_Name",
                schema: "mymarina",
                table: "pricing_plans",
                columns: new[] { "MarinaId", "Name" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_slips_PricingPlanId",
                schema: "mymarina",
                table: "slips",
                column: "PricingPlanId",
                filter: "\"PricingPlanId\" IS NOT NULL");
