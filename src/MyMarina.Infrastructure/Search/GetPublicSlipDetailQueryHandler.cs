    ...
    : IQueryHandler<GetPublicSlipDetailQuery, SlipDetailDto>
{
    public async Task<SlipDetailDto> HandleAsync(GetPublicSlipDetailQuery query, CancellationToken ct = default)
    {
        ...
        return new SlipDetailDto(
            ...
            ResolvedTransientBaseRate: slip.ResolvedTransientBaseRate,
            TransientBookingAvailable: slip.ResolvedTransientBaseRate.HasValue,
            ResolvedLeaseBaseRate:     slip.ResolvedLeaseBaseRate,
            LeaseInquiryAvailable:     slip.ResolvedLeaseBaseRate.HasValue,
